...
train_val_loader = DataLoader(train_val_set, batch_size=batch_size, shuffle=True, num_workers=16)
...
# save model
torch.save(model_best, 'model_vgg.torch')
...
#將結果寫入 csv 檔
with open("predict_vgg.csv", 'w') as f:
    f.write('Id,Category\n')
